...
if (document.getElementById("export-table") && typeof simpleDatatables.DataTable !== 'undefined') {
    ...
    const createRoute = tableElement ? tableElement.dataset.createRoute : '#'; // Fallback to '#' if element not found or attribute missing
    const resourceName = tableElement ? tableElement.dataset.resourceName : 'Baru'; // Default to 'Baru' if not specified
...
window.viewData = function(index) {
    console.log('View data at index:', index);
    // Fungsi view
}
...
window.deleteData = function(index) {
    console.log('Delete data at index:', index);
    // Fungsi delete
}