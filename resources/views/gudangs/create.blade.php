...
<body>
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="bg-white rounded-lg shadow-md p-6 w-full max-w-md">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-800">Tambah Gudang</h1>
                <p class="text-sm text-gray-600 mb-4">Silakan isi form di bawah ini untuk menambahkan gudang baru.</p>
            </div>
            ...
            <form action="{{ route('gudangs.store') }}" method="POST">
                ...
                <div class="mb-12">
                    <div class="flex items-center mb-2 gap-1">
                        <label for="nama_gudang_toko" class="text-sm font-medium text-gray-700">Nama Gudang</label>
