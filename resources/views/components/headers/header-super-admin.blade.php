  ...
  aria-label="Sidebar">
    <div class="h-[95%] px-3 py-4 overflow-y-auto bg-[#161A30] rounded-xl shadow-lg mx-auto w-[95%] flex flex-col">
       ...
       <ul class="pl-2 flex-grow overflow-y-auto">
          ...
          <li>
            <a href="{{ route('activity-logs.index') }}" class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group">
               <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <span class="flex-1 ms-3 mr-5">Log Aktivitas</span>                
            </a>
         </li>
          <li>
