...
<body>
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="bg-white rounded-lg shadow-md p-6 w-full max-w-xl">
            ...
            <form action="{{ route('pusat-ke-cabangs.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-12">
                    ...
                    <div class="mb-6 flex justify-center items-center gap-4">
                        ...
                        <div class="flex flex-col w-full">
                            <div class="flex items-center mb-2 gap-1">
                                <label for="id_cabang" class="text-sm font-medium text-gray-700">Pilih Gudang Cabang</label>
                                <label for="id_cabang" class="text-sm font-medium text-red-600">*</label>
                            </div>
                            <select name="id_cabang" class="w-full p-2 rounded-lg">
