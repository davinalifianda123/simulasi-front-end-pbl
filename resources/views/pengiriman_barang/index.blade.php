...
<x-default-layout :nama-user="$nama_user" :nama-role="$nama_role">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex justify-center items-center">
            <table id="export-table" data-create-route="{{ $status_opname ? '#' : route('pusat-ke-cabangs.create') }}" data-resource-name="Pengiriman Barang" data-route-name="pusat-ke-cabangs" data-editable="false" data-user-role="{{ $nama_role }}">
                <thead>
                    <tr>
