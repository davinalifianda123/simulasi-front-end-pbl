...
<x-default-layout :nama-user="$nama_user" :nama-role="$nama_role">
    <div class="bg-white rounded-lg shadow-md p-6 flex justify-center items-center">
        ...
        <table id="export-table" data-create-route="{{ route('penerimaan-di-cabangs.create') }}" data-resource-name="Penerimaan Barang">
            <thead>
                <tr>
            ...
            <tbody>
                @forelse ($penerimaanDiCabangs as $penerimaanDiCabang)
                    <tr class="hover:bg-gray-50 cursor-pointer">
                        ...
                        <td>{{ $penerimaanDiCabang->kurir }}</td>
                        <td>{{ $penerimaanDiCabang->status }}</td>
                    </tr>
                @empty
                    <tr>
