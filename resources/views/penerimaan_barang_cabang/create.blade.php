                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <select name="id_jenis_penerimaan" id="jenisPenerimaan" class="w-full p-2 rounded-lg bg-gray-100" disabled>
                                @foreach ($jenisPenerimaans as $jenisPenerimaan)
                                    <option value="{{ $jenisPenerimaan->id }}" {{ strtolower($jenisPenerimaan->nama_jenis_penerimaan) === 'retur' ? 'selected' : '' }}>
                                        {{ $jenisPenerimaan->nama_jenis_penerimaan }}
                                    </option>
                                @endforeach
                            </select>
                            @php
                                $pengiriman = collect($jenisPenerimaans)->firstWhere('nama_jenis_penerimaan', 'retur');
                            @endphp
