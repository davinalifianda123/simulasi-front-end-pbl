...
<x-default-layout :nama-user="$nama_user" :nama-role="$nama_role">
    <div class="bg-white rounded-lg shadow-md p-6">
        <div class="flex justify-center items-center">
            <table id="export-table" data-create-route="{{ route('suppliers.create') }}" data-resource-name="Supplier" data-route-name="suppliers" data-editable="true" data-deleteable="true" data-user-role="{{ $nama_role }}">
                <thead>
                    <tr>
